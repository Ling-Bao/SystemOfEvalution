...
protected:
	...
	afx_msg void OnZbsfk();
	afx_msg void OnPjsfk();
	afx_msg void OnQtzsk();
	afx_msg void OnYssj();
	afx_msg void OnPjzbsj();
	afx_msg void OnMcxzy();
	afx_msg void OnXmcgbg();
	afx_msg void OnTapcg();
	afx_msg void OnJspjym();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
